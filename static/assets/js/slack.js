$(document).ready(function () {
    ...
    var documentReference = db.collection('tokens').doc('oRdi0ncSAL6XkJsqUIVi');
    ...
    documentReference.get().then(function (snapshot) {
        slackToken = snapshot.data().slack

        var slackChatOptions = {
            apiToken: slackToken, // Legacy Auth Token of @chat_bot
            channelId: 'CEC4Z0BFY',
            user: userName,
